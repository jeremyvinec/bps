                ...
                <main>
                    ...
                    <section className="container">
                        ...
                        <div className="row" style={{ marginTop: 150 }}>
                            ...
                            <div className="col-sm line2">
                                <Line2/>
                            </div>
                            <div className="col-sm text-left" style={{ marginTop: 50 }}>
                                <Gear/>
                        ...
                        <div className="row" style={{ marginTop: 150 }}>
                            ...
                            <div className="col-sm arrow3"></div>
                        </div>
                    </section>
                </main>
                <Footer/>
